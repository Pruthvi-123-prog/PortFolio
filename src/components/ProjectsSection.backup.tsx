...
impor    <div className="w-full min-h-screen flex flex-col items-center justify-start bg-background relative">
      <section id="projects" className="w-full py-12 sm:py-20 relative">
        {/* Background Elements */}
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" ref={ref}>rnalLink, Github, Eye, Code, ArrowRight, Globe, Shield, Smartphone, Brain } from 'lucide-react'
...
export default function ProjectsSection() {
  ...
  return (
    <section id="projects" className="relative py-12 sm:py-20 bg-background w-full min-h-screen flex flex-col">
      {/* Background Elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 right-1/4 w-48 sm:w-72 h-48 sm:h-72 bg-accent/5 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 left-1/4 w-64 sm:w-96 h-64 sm:h-96 bg-primary-500/5 rounded-full blur-3xl" />
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex-1" ref={ref}>
        {/* Section Header */}
        <motion.div
